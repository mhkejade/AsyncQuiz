...
namespace PrepareBreakfastAsync
{
    class Program
    {
        ...
        private static async Task PrepareBreakFast(int eggsToFry, int baconToFry, int breadToToast)
        {
            ...
            var _bacontask = FryBaconAync(baconToFry);
            var _toasttask = PrepareToast(breadToToast);
        ...
        private async static Task<Bacon> FryBaconAync(int slices)
        {
        ...
        private static async Task<Toast> PrepareToast(int bread)
        {
